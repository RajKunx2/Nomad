    ...
    <>
      <div className="justify-center mt-20 flex px-[40px] py-0">
        <Marquee gradient={false} speed={200}>
          <h1 className="text-xl font-bold md:text-2xl lg:text-2xl h-auto font-mono text-[#fff] justify-center m-auto">
      ...
      <div className="w-screen space-around h-auto bg-opacity-60 backdrop-blur-2xl mt-20 flex pt-0 flex-col lg:flex-row justify-center align-middle">
        <div className="mt-0 bg-opacity-10 backdrop-blur-xl">
          <div className="font-bold p-auto text-sm text-center justify-center align-middle w-auto text-[#ffffff] m-auto mt-6 mb-4">
        ...
        <div className="m-auto flex justify-center align-middle flex-col bg-opacity-10 backdrop-blur-xl">
          <div className="flex font-bold justify-center m-auto text-[#ffffff] flex-col mt-1">
        ...
        <div className="m-auto flex justify-center align-middle flex-col bg-opacity-10 backdrop-blur-xl">
          <div className="flex font-bold justify-center m-auto text-[#ffffff] flex-col mt-3">
            KEEP IN TOUCH
          </div>
          <div>
            <Image width={240} height={32} alt=""
